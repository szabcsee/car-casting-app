...
function fixFooterPosition() {
  ...
  var navbarHeigh = $('#left-panel').height();
  var wrapperMinHeigh = $('#main').css("min-height");
  wrapperMinHeigh = parseInt(wrapperMinHeigh.substring(0, wrapperMinHeigh.length-2));

  if(navbarHeigh > wrapperMinHeigh){
    $('#main').css("min-height", (navbarHeigh + 36) + "px");
  }
